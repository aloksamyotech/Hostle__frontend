...
export const administratorValidationSchema = Yup.object({
  ...
  phoneNumber: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone number is required'),
  aadharCard: Yup.string().matches(/^\d{12}$/,'Aadhar Card ID must be exactly 12 digits').required('Aadhar Card ID is required'),
...
export const studentValidationSchema = Yup.object({
  ...
  password: Yup.string().required('Password is required').min(8, 'Password must be at least 8 characters')
    .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d@$!%*?&]{8,}$/,'Password must be at least 8 characters long and contain at least one lowercase letter, one uppercase letter, and one number'),
  phoneNumber: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone number is required'),
  aadharCardId: Yup.string().matches(/^\d{12}$/,'Aadhar Card ID must be exactly 12 digits').required('Aadhar Card ID is required'),
  state: Yup.string().required('State is required'),
  city: Yup.string().required('City is required'),
  address: Yup.string().required('Address is required'),
  photo: Yup.string().required('Photo is required'),
  ...
  hostelName: Yup.string().matches(/^[A-Za-z\s]+$/, 'Name must contain only letters').required('Name is required'),
  email: Yup.string().email('Invalid email').required('Email is required'),
  // password: Yup.string().required('Password is required').min(8, 'Password must be at least 8 characters')
  //   .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d@$!%*?&]{8,}$/,'Password must be at least 8 characters long and contain at least one lowercase letter, one uppercase letter, and one number'),
  phoneNumber: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone number is required'),
...
export const hostelNewValidationSchema = Yup.object({
  hostelName: Yup.string().matches(/^[A-Za-z\s]+$/, 'Name must contain only letters').required('Hostel Name is required'),
  hostelPhoneNumber: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone number is required'),
  ownerName: Yup.string().matches(/^[A-Za-z\s]+$/, 'Name must contain only letters').required('Owner Name is required'), 
  ownerPhoneNumber: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone number is required'),
  email: Yup.string().email('Invalid email').required('Email is required'),
  password: Yup.string().required('Password is required').min(8, 'Password must be at least 8 characters')
    .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d@$!%*?&]{8,}$/,'Password must be at least 8 characters long and contain at least one lowercase letter, one uppercase letter, and one number'),
  state: Yup.string().required('State is required'),
...
export const editHostelValidationSchema = Yup.object({
 ...
 export const roomValidationSchema = Yup.object({
  ...
  studentPhoneNo: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone Number is required'),
  fathersName: Yup.string().required('Fathers Name is required'),  
  fathersPhoneNo: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone Number is required'),
  dateOfBirth: Yup.date().required('Date of Birth is required'),
  gender: Yup.string().required('Gender is required'),
  email: Yup.string().email('Invalid email').required('Email is required'),
...
export const editStudentValidationSchema = Yup.object({
  ...
  visitorName: Yup.string().matches(/^[A-Za-z\s]+$/, 'Name must contain only letters').required('Visitor Name is required'),
  phoneNumber: Yup.string().matches(/^[6-9]\d{9}$/,'Invalid phone number').required('Phone Number is required'),
