        ...
        <Card>
          <Box p={3}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Typography variant="body1">
                  <strong>Room Type:</strong> {roomDetail?.roomType} ({roomDetail?.roomCategory})
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <Typography variant="body1">
                  <strong>Total No.of Beds:</strong> {roomDetail?.noOfBeds}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <Typography variant="body1">
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Typography variant="body1">
                  <strong>Room Price:</strong> ₹ {roomDetail?.roomPrice}
                </Typography>
              </Grid>
            </Grid>
          </Box>
